...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(
                                    ...
                                    placeholder = 'Select a Launcch Site here',
                                    searchable = True,
                                    value = 'All'
                                    ),
                                html.Br(),
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        fig = px.pie(spacex_df, 
                     values = 'class', 
                     names = 'Launch Site', 
                     title = 'All Succesfull Launches By Site ')
    else: 
        ...
        fig = px.pie(filtered_df,
                     values = 'Unnamed: 0',
                     names = 'class',
                     title = 'All Launches for site {}'.format(entered_site))
    return fig
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(
                         ...
                         title = 'All sites = payload mass between {:8,d} and {:8,d}kg'.format(int(payload_range[0]), int(payload_range[1]))
                         )
    else:
        filtered_df = spacex_df[
